    ...
    <div className={cn(
      ...
      <div className="space-y-1">
        ...
        <p className="leading-relaxed">
            AI assists in creation of these articles. However, the curation, editing, direction, core ideas a product of my vision, hence the final result - whether good or bad - is my responsibility.
        </p>
      </div>
    </div>
  );
